          ...
          <>
            <div className={styles.sale_info}>
              ...
              <div className={styles.info_row}>
                ...
                <span className={`${styles.value} ${styles[sale.status.toLowerCase()]}`}>
                  {sale.status}
                </span>
              </div>
            </div>
                ...
                <tbody>
                  {items.map((item) => (
                    <tr key={item.id}>
                      ...
                      <td className={styles.gtin}>{item.produto_gtin}</td>
                      <td className={styles.center}>{item.quantidade}</td>
                      <td className={styles.price}>R$ {item.preco_unitario.toFixed(2)}</td>
                      <td className={styles.price}>R$ {item.subtotal.toFixed(2)}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
            ...
            <div className={styles.total_row}>
              ...
              <span className={styles.total_value}>R$ {sale.valor_total.toFixed(2)}</span>
            </div>
          </>
        )}
      </div>
