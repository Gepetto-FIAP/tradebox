...
export default function Home() {
  return (
    <div className={styles.home_content}>
      ...
      <section id="solucoes" className={styles.comparison_section} style={{ display: 'none' }}>
        <div className={styles.section_header}>
      ...
      <section id="recursos" className={styles.benefits_section} style={{ display: 'none' }}>
        <div className={styles.section_header}>
      ...
      <section className={styles.features} style={{ display: 'none' }}>
        <div className={styles.section_header}>
      ...
      <section id="equipe" className={styles.team_section} style={{ display: 'none' }}>
        <div className={styles.section_header}>
      ...
      <section className={styles.cta_section} style={{ display: 'none' }}>
